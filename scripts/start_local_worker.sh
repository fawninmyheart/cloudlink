...
: "${CLOUDLINK_SCRIPT_MAX_TIMEOUT_SECONDS:=31536000}"
: "${CLOUDLINK_TASK_LEASE_RENEW_SECONDS:=5}"
...
export CLOUDLINK_TASK_LEASE_RENEW_SECONDS
...
export CLOUDLINK_GPU_ENABLED
export CLOUDLINK_GPU_ENVIRONMENT_PATH
export CLOUDLINK_MICROMAMBA_EXE
...
echo "  GPU runtime: enabled=$CLOUDLINK_GPU_ENABLED environment=${CLOUDLINK_GPU_ENVIRONMENT_PATH:-none}"
